...
import {
  StyledTextInput, StyledText16, StyledText17, StyledText18,
  StyledText19, StyledText20, StyledText21, StyledText22,
  StyledText23, StyledText9
} from './fast.style';

type RoutePropsType = StackScreenProps<LoggedStackParamList, 'FastEnd'>;
class FastEnd extends React.Component<RoutePropsType & ReduxPropsType & PagePropsType, any> {
  ...
  render() {
    const { Emotes: { Asset9, Asset10, Asset11, Asset12, Asset13 } } = ASSETS.FASTING.svgs
    ...
    return (
      <>
        ...
        <View style={{ height: 200, width: '100%' }}>
          <ImageBackground resizeMode='cover' style={{ flex: 1, justifyContent: 'flex-end', paddingHorizontal: 40, paddingVertical: 30 }} source={backgrounds['tertiary']}>
            <View>
        ...
        {/* === */}
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'flex-start', marginHorizontal: 40, paddingTop: 30 }}>
          ...
          <View style={{ marginTop: 40, width: '100%' }}>
            ...
            <StyledTextInput multiline={true} placeholder="Add a Note" placeholderTextColor="#FFF" />
          </View>
        </View>
      </>
    )
