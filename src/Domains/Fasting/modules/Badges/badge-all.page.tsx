...
import { StyledText3, StyledText4, StyledText5 } from './badge.style';
    ...
    return (
      <View
        ...
        <View
          ...
          <StyledText3>Join a Challange</StyledText3>
          <Text />
          <StyledText4>
            Challenge yourself to better Health and unlock Exclusive
            Achievements along the way. With Challenges you can fast along with
            our experts, Invite Friends to tackle a Challenge alongside you, And
            fast forward to your goals.
          </StyledText4>
        </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(BadgeAll);
