...
class BadgeList extends React.Component<RoutePropsType & ReduxPropsType & PagePropsType, any> {

  constructor(props) {
    super(props)
    this.props.setPageConfigs({
      topBarConfig: { title: 'View all badges', menu: true, color: '#FFF', back: true }
    })
  }
