  ...
  render() {
    ...
    return (
      <>
        {/* == */}
        <View
          style={{ height: 170, alignItems: 'center', marginHorizontal: 40 }}>
          <View style={{ width: '100%', paddingHorizontal: 20 }}>
            <StyledText3>JOURNAL</StyledText3>
            <Text />
            <StyledText4>7 Days</StyledText4>
          ...
          <ImageBackground
            ...
            <View
              ...
              <View
                ...
                <Button color="tertiary">JOIN CHALLENGE</Button>
              </View>
            ...
            <ScrollView
              ...
              {challengeItens.map((item, idx) => (
                <TouchableOpacity
                  onPress={() => this.goToBadgeView(item)}
                  style={{
                    width: '100%',
                    paddingVertical: 29,
                    flexDirection: 'row',
